...
type VCRClient interface {
	...
	GetOrganizationWithCredentialType(ctx context.Context, organizationDID, credentialType string) ([]map[string]interface{}, error)
...
func (c HTTPClient) GetOrganizationWithCredentialType(ctx context.Context, organizationDID, credentialType string) ([]map[string]interface{}, error) {
	return c.searchVCR(ctx, organizationConcept, []vcr.KeyValuePair{
		{Key: "subject", Value: organizationDID},
