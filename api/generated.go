...
type ServerInterface interface {
	...
	// (POST /auth/webauthn)
	AuthenticateWithWebAuthn(ctx echo.Context) error
...
// AuthenticateWithWebAuthn converts echo context to params.
func (w *ServerInterfaceWrapper) AuthenticateWithWebAuthn(ctx echo.Context) error {
	var err error

	ctx.Set(BearerAuthScopes, []string{})

	// Invoke the callback with all the unmarshaled arguments
	err = w.Handler.AuthenticateWithWebAuthn(ctx)
	return err
}
...
func RegisterHandlersWithBaseURL(router EchoRouter, si ServerInterface, baseURL string) {
	...
	router.POST(baseURL+"/auth/webauthn", wrapper.AuthenticateWithWebAuthn)
