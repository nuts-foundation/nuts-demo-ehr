...
type Repository interface {
	...
	UpdateNegotiationState(ctx context.Context, customerID, negotiationID string, newState domain.TransferNegotiationStatusStatus) (*domain.TransferNegotiation, error)
