...
type NotifyTransferUpdateParams = types.NotifyTransferUpdateParams

func (w Wrapper) NotifyTransferUpdate(ctx echo.Context, params NotifyTransferUpdateParams) error {
