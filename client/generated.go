...
type ClientInterface interface {
	...
	CreateJwtBearerTokenWithBody(ctx context.Context, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*http.Response, error)

	CreateJwtBearerToken(ctx context.Context, body CreateJwtBearerTokenJSONRequestBody, reqEditors ...RequestEditorFn) (*http.Response, error)
	...
	CreateAccessToken(ctx context.Context, body CreateAccessTokenJSONRequestBody, reqEditors ...RequestEditorFn) (*http.Response, error)
...
func (c *Client) CreateJwtBearerTokenWithBody(ctx context.Context, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*http.Response, error) {
...
func (c *Client) CreateJwtBearerToken(ctx context.Context, body CreateJwtBearerTokenJSONRequestBody, reqEditors ...RequestEditorFn) (*http.Response, error) {
...
func (c *Client) CreateAccessToken(ctx context.Context, body CreateAccessTokenJSONRequestBody, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewCreateAccessTokenRequest(c.Server, body)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
func NewCreateJwtBearerTokenRequestWithBody(server string, contentType string, body io.Reader) (*http.Request, error) {
	...
	operationPath := fmt.Sprintf("/internal/auth/v1/bearertoken")
	if operationPath[0] == '/' {
		operationPath = operationPath[1:]
	}
	operationURL := url.URL{
...
func NewCreateAccessTokenRequest(server string, body CreateAccessTokenJSONRequestBody) (*http.Request, error) {
	var bodyReader io.Reader
	buf, err := json.Marshal(body)
	if err != nil {
		return nil, err
	...
	bodyReader = bytes.NewReader(buf)
	return NewCreateAccessTokenRequestWithBody(server, "application/json", bodyReader)
}
...
type ClientWithResponsesInterface interface {
	...
	// CreateJwtBearerToken request  with any body
	CreateJwtBearerTokenWithBodyWithResponse(ctx context.Context, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*CreateJwtBearerTokenResponse, error)

	CreateJwtBearerTokenWithResponse(ctx context.Context, body CreateJwtBearerTokenJSONRequestBody, reqEditors ...RequestEditorFn) (*CreateJwtBearerTokenResponse, error)
	...
	CreateAccessTokenWithResponse(ctx context.Context, body CreateAccessTokenJSONRequestBody, reqEditors ...RequestEditorFn) (*CreateAccessTokenResponse, error)
...
func (c *ClientWithResponses) CreateJwtBearerTokenWithBodyWithResponse(ctx context.Context, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*CreateJwtBearerTokenResponse, error) {
	rsp, err := c.CreateJwtBearerTokenWithBody(ctx, contentType, body, reqEditors...)
	if err != nil {
		return nil, err
	}
...
func (c *ClientWithResponses) CreateJwtBearerTokenWithResponse(ctx context.Context, body CreateJwtBearerTokenJSONRequestBody, reqEditors ...RequestEditorFn) (*CreateJwtBearerTokenResponse, error) {
	rsp, err := c.CreateJwtBearerToken(ctx, body, reqEditors...)
	if err != nil {
		return nil, err
	}
	return ParseCreateJwtBearerTokenResponse(rsp)
...
func (c *ClientWithResponses) CreateAccessTokenWithResponse(ctx context.Context, body CreateAccessTokenJSONRequestBody, reqEditors ...RequestEditorFn) (*CreateAccessTokenResponse, error) {
	rsp, err := c.CreateAccessToken(ctx, body, reqEditors...)
	if err != nil {
		return nil, err
	}
	return ParseCreateAccessTokenResponse(rsp)
