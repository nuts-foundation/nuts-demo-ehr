...
// ContactInformation A set of contact information entries
type ContactInformation struct {
	// Email email address for normal priority support
	Email string `json:"email"`

	// Name The commonly known name of the service provider
	Name string `json:"name"`

	// Phone phoneNumber for high priority support
	Phone string `json:"phone"`

	// Website URL of the public website of this Service Provider. Can point to a Nuts specific page with more information about the node and how to contact.
	Website string `json:"website"`
}

// Endpoint A combination of type and URL.
type Endpoint struct {
	Id string `json:"id"`

	// ServiceEndpoint An endpoint URL or a reference to another service.
