...
oapi-codegen -generate client,types -package vcr -exclude-schemas SearchVCRequest,VerifiableCredential -o nuts/client/vcr/generated.go https://nuts-node.readthedocs.io/en/latest/_static/vcr/v2.yaml
